<template>
  <div class="page">
    <div class="jarallax">
      <img
        class="jarallax-img"
        src="https://cdn.pixabay.com/photo/2020/07/06/07/47/road-5375897_1280.jpg"
        alt="image"
      />
    </div>
    <div class="map">
      ...
      >
        ...
        ></path>
        <path
          d="M336.2 147.4l2.3 43.1 31.1 129.5 1.1 2.2-10.8-1.9-61.9 3.6-3.1-0.6-9.5-6.5-16.1-8-4-3.2-2-3.6-4.7-12.3-1-3.9-1.7-3-8.2-3-2.5-2-0.7-10.1 0.8-12.1-2.8-10.2-11.6-4.3-31.7-0.3-7.3-2.7-3.8-8.8 3.2-6.2 9-26 1.1-7.2-1.1-3.6 0-2.8 0.8-3 2.9-6.1 5-8 3.6-3.4 6.9-3.4 52.3-18.7 64.4 6.5z"
          id="JAM1373"
        ...
        ></path>
        <path
          d="M416 24.6l-1.1 10.6 0.3 3.9 5.3 13.7 0.3 3.4-0.3 2.8-1.2 3.1 0 1.7 0.6 1.3 2.4 3.1 0 4.5-18.1 86.6-20.4-14.2-6.5-2.9-1.4 0.1-17.5-2.7-2.6 0-2.6 0.7-3.3 1.5-5.1 3.1-2.8 1.1-5.8 1.4-64.4-6.5 20.7-130.2 0.2-0.8 32.4 7.1 44.4 0.8 19.6 4.8 26.9 2z"
          id="JAM1375"
          name="Trelawny"
        ></path>
        <path
        ...
        ></path>
        <path
          d="M753 275.8l-3.4-3.3-5.9-1.4-13.8-0.2-9.4 0.2-6.5-3.9 1.5-4.4 0.8-1.8 3.5-2.3 4.6-1.9 3.8-1 11.8-0.6 6.8 1.6 4.5 2.4 3.8 8.9 0.4 6.2-2.5 1.5z"
          id="JAM1377"
          name="Kingston"
        ></path>
        <path
        ...
        <path
          ...
          @mouseenter="par"
        ></path>
        <circle cx="47.4" cy="95.9" id="0"></circle>
        <circle cx="864.2" cy="285.6" id="1"></circle>
        <circle cx="453.4" cy="29.1" id="2"></circle>
      </svg>
    </div>
    <div class="parish">
      <h1>{{parish}}</h1>
